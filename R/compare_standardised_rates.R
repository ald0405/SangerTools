...
compare_standardised_rates <-
  ...
  message("Locality A Age Standardised Prevalence Rate: ",
          round(standard_rate_a, 2))

  message("Locality B Age Standardised Prevalence Rate: ",
          round(standard_rate_b, 2))

  message(
    "The Comparative Age Standardised Prevalence Ratio of Locality A to Locality B is ",
    round(standard_rate_a / standard_rate_b, 3)
  )
